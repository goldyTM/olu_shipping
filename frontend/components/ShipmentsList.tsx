              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {shipment.invoicePdfUrl && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => handleDownload(shipment.invoicePdfUrl!, `invoice-${shipment.vendor_decl_id}.pdf`)}
                    className="flex items-center space-x-1"
                  >
                ...
                {shipment.packingListPdfUrl && (
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => handleDownload(shipment.packingListPdfUrl!, `packing-list-${shipment.vendor_decl_id}.pdf`)}
                    className="flex items-center space-x-1"
                  >
                    <Download className="w-4 h-4" />
