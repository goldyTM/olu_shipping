...
```bash
git remote add encore encore://olu-shipping-company-7b62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/olu-shipping-company-7b62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/olu-shipping-company-7b62/settings/integrations/github)
